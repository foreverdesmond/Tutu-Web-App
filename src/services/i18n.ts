...
const translations: Record<string, Record<TranslationKey, string>> = {
  en: {
    ...
    'tokenomics.contract_info': 'Contract Information',
  ...
  'zh-CN': {
    ...
    'tokenomics.contract_address': '合约地址',
    'tokenomics.contract_info': '合约信息',
  ...
  ko: {
    ...
    'tokenomics.contract_address': '계약 주소',
    'tokenomics.contract_info': '계약 정보',
